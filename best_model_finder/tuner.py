...
class Model_Finder:
    ...
    def get_best_params_for_random_forest(self, train_x, train_y):
        """
                ...
                Description: get the parameters for Random Forest Algorithm which give the best accuracy/ AUC score.
        ...
        try:
            # initializing with different combination of parameters for gird search
